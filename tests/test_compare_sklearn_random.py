...
def _run_and_assert(n: int, fraction_negative: float, with_weights: bool, dtype: DTypeLike, score_dtype: DTypeLike, f_skl, f, **kwargs):
...
@all_parameters
def test_average_precision(n: int, fraction_negative: float, with_weights: bool, dtype: DTypeLike, score_dtype: DTypeLike):
...
@all_parameters
def test_roc_auc(max_fpr: float | None, n: int, fraction_negative: float, with_weights: bool, dtype: DTypeLike, score_dtype: DTypeLike):
